...
def get_pixels_hu(slices):
    ...
    print(slices[0].SliceThickness, slices[0].PixelSpacing)
...
def step1_python(case_path):
    print('load...', case_path)
    case = load_scan(case_path)
    print('loaded...', case_path)
...
if __name__ == '__main__':
    INPUT_FOLDER = '/home/rqy_local/data/stage1/stage1/'
